...
*/
// param_arr_num
char eq_1(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) {
...
// param_num_arr
char eq_3(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
char eq_5(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
char eq_1_x86_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) { 
...
// param_num_arr
char eq_3_x86_simd(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
char eq_5_x86_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
char eq_1_armv7_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) { 
...
// param_num_arr
char eq_3_armv7_simd(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
char eq_5_armv7_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
char eq_1_armv8_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) { 
...
// param_num_arr
char eq_3_armv8_simd(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
char eq_5_armv8_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
/* This selects the correct function, whether the platform independent non-SIMD
   ...
   param = The parameter to be applied to each array element.
*/
char eq_1_select(Py_ssize_t arraylen, int nosimd, unsigned char *data1, unsigned char param) { 
...
/* This selects the correct function, whether the platform independent non-SIMD
   ...
   param = The parameter to be applied to each array element.
*/
char eq_3_select(Py_ssize_t arraylen, int nosimd, unsigned char param, unsigned char *data2) { 
...
/* This selects the correct function, whether the platform independent non-SIMD
   ...
   param = The parameter to be applied to each array element.
*/
char eq_5_select(Py_ssize_t arraylen, int nosimd, unsigned char *data1, unsigned char *data2) { 
...
static PyObject *py_eq(PyObject *self, PyObject *args, PyObject *keywds) {
	...
	switch (bytesdata.paramcat) {
		case param_arr_num : {
			resultcode = eq_1_select(bytesdata.byteslength, bytesdata.nosimd, bytesdata.bytes1.B, bytesdata.param);
			break;
		}
		case param_num_arr : {
			resultcode = eq_3_select(bytesdata.byteslength, bytesdata.nosimd, bytesdata.param, bytesdata.bytes2.B);
			break;
		}
		case param_arr_arr : {
			resultcode = eq_5_select(bytesdata.byteslength, bytesdata.nosimd, bytesdata.bytes1.B, bytesdata.bytes2.B);
			break;
		}
	}
