...
char gt_1_armv8_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) { 
...
// param_num_arr
char gt_3_armv8_simd(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
char gt_5_armv8_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
