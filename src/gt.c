...
*/
// param_arr_num
signed int gt_1(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) {
...
// param_num_arr
signed int gt_3(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
signed int gt_5(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
signed int gt_1_x86_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) { 
...
// param_num_arr
signed int gt_3_x86_simd(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
signed int gt_5_x86_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
signed int gt_1_armv7_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) { 
...
// param_num_arr
signed int gt_3_armv7_simd(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
signed int gt_5_armv7_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
signed int gt_1_armv8_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) { 
...
// param_num_arr
signed int gt_3_armv8_simd(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
signed int gt_5_armv8_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
/* This selects the correct function, whether the platform independent non-SIMD
   ...
   param = The parameter to be applied to each array element.
*/
signed int gt_1_select(Py_ssize_t arraylen, int nosimd, unsigned char *data1, unsigned char param) { 
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		#if defined(AF_HASSIMD_ARM_AARCH64)
			return gt_1_armv8_simd(arraylen, data1, param);
		#endif
...
/* This selects the correct function, whether the platform independent non-SIMD
   ...
   param = The parameter to be applied to each array element.
*/
signed int gt_3_select(Py_ssize_t arraylen, int nosimd, unsigned char param, unsigned char *data2) { 
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		#if defined(AF_HASSIMD_ARM_AARCH64)
			return gt_3_armv8_simd(arraylen, param, data2);
		#endif
...
/* This selects the correct function, whether the platform independent non-SIMD
   ...
   param = The parameter to be applied to each array element.
*/
signed int gt_5_select(Py_ssize_t arraylen, int nosimd, unsigned char *data1, unsigned char *data2) { 
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		...
		#if defined(AF_HASSIMD_ARM_AARCH64)
			return gt_5_armv8_simd(arraylen, data1, data2);
		#endif
...
static PyObject *py_gt(PyObject *self, PyObject *args, PyObject *keywds) {
	...
	switch (bytesdata.paramcat) {
		case param_arr_num : {
			resultcode = gt_1_select(bytesdata.arraylen, bytesdata.nosimd, bytesdata.bytes1.B, bytesdata.param);
			break;
		}
		case param_num_arr : {
			resultcode = gt_3_select(bytesdata.arraylen, bytesdata.nosimd, bytesdata.param, bytesdata.bytes2.B);
			break;
		}
		case param_arr_arr : {
			resultcode = gt_5_select(bytesdata.arraylen, bytesdata.nosimd, bytesdata.bytes1.B, bytesdata.bytes2.B);
			break;
		}
	}
