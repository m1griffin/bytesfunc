...
// Project:  bytesfunc
// Module:   lt.c
// Purpose:  Calculate the lt of values in a bytes or bytearray object.
// Language: C
// Date:     02-Nov-2019.
//
//------------------------------------------------------------------------------
...
*/
// param_arr_num
signed int lt_1(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) {
...
// param_num_arr
signed int lt_3(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
signed int lt_5(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
signed int lt_1_x86_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) { 
...
// param_num_arr
signed int lt_3_x86_simd(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
signed int lt_5_x86_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
signed int lt_1_armv7_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) { 
...
// param_num_arr
signed int lt_3_armv7_simd(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
signed int lt_5_armv7_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
signed int lt_1_armv8_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char param) { 
...
// param_num_arr
signed int lt_3_armv8_simd(Py_ssize_t arraylen, unsigned char param, unsigned char *data2) {
...
// param_arr_arr
signed int lt_5_armv8_simd(Py_ssize_t arraylen, unsigned char *data1, unsigned char *data2) {
...
/* This selects the correct function, whether the platform independent non-SIMD
   ...
   param = The parameter to be applied to each array element.
*/
signed int lt_1_select(Py_ssize_t arraylen, int nosimd, unsigned char *data1, unsigned char param) { 
	...
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		#if defined(AF_HASSIMD_X86)
			return lt_1_x86_simd(arraylen, data1, param);
		#endif

		#if defined(AF_HASSIMD_ARMv7_32BIT)
			return lt_1_armv7_simd(arraylen, data1, param);
		#endif


		#if defined(AF_HASSIMD_ARM_AARCH64)
			return lt_1_armv8_simd(arraylen, data1, param);
		#endif

	} else {
	#endif
		return lt_1(arraylen, data1, param);
	#if defined(AF_HASSIMD_X86) || defined(AF_HASSIMD_ARMv7_32BIT) || defined(AF_HASSIMD_ARM_AARCH64)
	}
	#endif
...
/* This selects the correct function, whether the platform independent non-SIMD
   ...
   param = The parameter to be applied to each array element.
*/
signed int lt_3_select(Py_ssize_t arraylen, int nosimd, unsigned char param, unsigned char *data2) { 

	#if defined(AF_HASSIMD_X86) || defined(AF_HASSIMD_ARMv7_32BIT) || defined(AF_HASSIMD_ARM_AARCH64)
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		#if defined(AF_HASSIMD_X86)
			return lt_3_x86_simd(arraylen, param, data2);
		#endif

		#if defined(AF_HASSIMD_ARMv7_32BIT)
			return lt_3_armv7_simd(arraylen, param, data2);
		#endif

		#if defined(AF_HASSIMD_ARM_AARCH64)
			return lt_3_armv8_simd(arraylen, param, data2);
		#endif

	} else {
	#endif
		return lt_3(arraylen, param, data2);
	#if defined(AF_HASSIMD_X86) || defined(AF_HASSIMD_ARMv7_32BIT) || defined(AF_HASSIMD_ARM_AARCH64)
	}
	#endif
...
/* This selects the correct function, whether the platform independent non-SIMD
   ...
   param = The parameter to be applied to each array element.
*/
signed int lt_5_select(Py_ssize_t arraylen, int nosimd, unsigned char *data1, unsigned char *data2) { 

	#if defined(AF_HASSIMD_X86) || defined(AF_HASSIMD_ARMv7_32BIT) || defined(AF_HASSIMD_ARM_AARCH64)
	if (!nosimd && enoughforsimd(arraylen, CHARSIMDSIZE)) {
		#if defined(AF_HASSIMD_X86)
			return lt_5_x86_simd(arraylen, data1, data2);
		#endif

		#if defined(AF_HASSIMD_ARMv7_32BIT)
			return lt_5_armv7_simd(arraylen, data1, data2);
		#endif

		#if defined(AF_HASSIMD_ARM_AARCH64)
			return lt_5_armv8_simd(arraylen, data1, data2);
		#endif

	} else {
	#endif
		return lt_5(arraylen, data1, data2);
	#if defined(AF_HASSIMD_X86) || defined(AF_HASSIMD_ARMv7_32BIT) || defined(AF_HASSIMD_ARM_AARCH64)
	}
	#endif
...
static PyObject *py_lt(PyObject *self, PyObject *args, PyObject *keywds) {
	...
	bytesdata = getparams_comp(self, args, keywds, "lt");
	...
	switch (bytesdata.paramcat) {
		case param_arr_num : {
			resultcode = lt_1_select(bytesdata.arraylen, bytesdata.nosimd, bytesdata.bytes1.B, bytesdata.param);
			break;
		}
		case param_num_arr : {
			resultcode = lt_3_select(bytesdata.arraylen, bytesdata.nosimd, bytesdata.param, bytesdata.bytes2.B);
			break;
		}
		case param_arr_arr : {
			resultcode = lt_5_select(bytesdata.arraylen, bytesdata.nosimd, bytesdata.bytes1.B, bytesdata.bytes2.B);
			break;
		}
	}
