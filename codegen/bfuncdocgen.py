...
###############################################################################
#
#   Copyright 2018 - 2022    Michael Griffin    <m12.griffin@gmail.com>
#
...
def WriteDocs(summtable, opdocs, simdtable, pybench_x86, pybench_ARMv7, 
				pybench_ARMv8, versionnumber, versiondate, copyrightyear, ossupportdata):
...
def WriteReadMe(versionnumber, versiondate, copyrightyear, ossupportdata, releasehistory):
	...
	'''
	# Read in the entire template file.
	with open('bfuncreadmetemplate.rst', 'r') as f:
		doctmpl = f.read()
